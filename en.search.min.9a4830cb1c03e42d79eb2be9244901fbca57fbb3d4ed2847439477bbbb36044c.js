...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7655ced0ed7ddc363d73c747dadb631bea809008d73e845a5659305136e1671f.js',function(){input.required=false;search();});}
